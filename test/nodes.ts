...
must('painel à direita mostra a task e o estado', t.includes('task ─') && t.includes('in_progress') && t.includes('remove'));
must('cabeçalho conta a tarefa', t.includes('1 task'));
