...
const w = wrap('Olá! Estou no repositório do Wealth Studio, na branch fix/aw-650. Vi que há alguns arquivos não rastreados.\n\nQuer que eu faça o commit?', 40);
...
must('"agora" diz o estado, não repete a resposta', rs[rs.length - 1]!.kind === 'now' && rs[rs.length - 1]!.detail === 'esperando você');
