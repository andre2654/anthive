...
const skill = 'Base directory for this skill: /Users/x/.claude/skills/maestri\n\n# Maestri Inter-Agent Communication\n\nYou are running inside Maestri…';
const rs = rows([
...
must('preâmbulo nomeia as ferramentas e veta os outros canvases', SYSTEM_PREAMBLE.includes('note_write') && /maestri/.test(SYSTEM_PREAMBLE));
