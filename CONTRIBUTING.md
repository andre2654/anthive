...
- Tests that cost something are opt-in: `bun run test:chrome` (real Chrome, free), `bun run test:browser`, `bun run test:chat` and `bun run test:deep` (a haiku agent, a few cents).
